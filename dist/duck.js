	...
	function Duck() {
		...
		return (
			(_ret = ((_temp = ((_this = _possibleConstructorReturn(
				this,
				(_ref = Duck.__proto__ || Object.getPrototypeOf(Duck)).call.apply(
					_ref,
					[this].concat(args)
				)
			)),
	...
	function Dog() {
		...
		return (
			(_ret2 = ((_temp2 = ((_this2 = _possibleConstructorReturn(
				this,
				(_ref2 = Dog.__proto__ || Object.getPrototypeOf(Dog)).call.apply(
					_ref2,
					[this].concat(args)
				)
			)),
...
var Pig = (function(_Animal3) {
	...
	function Pig() {
		...
		return _possibleConstructorReturn(
			this,
			(Pig.__proto__ || Object.getPrototypeOf(Pig)).apply(this, arguments)
		);
	}
