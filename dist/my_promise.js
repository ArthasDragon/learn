...
Promise.all = function (args) {
  if (!Array.isArray(args)) {
    return console.error('the all args should be array but find ' + (typeof args === 'undefined' ? 'undefined' : _typeof(args)));
  }
...
p1().then(p2).then(p3, function (data) {
  console.log(data);
  return data;
}).then(function (data) {
